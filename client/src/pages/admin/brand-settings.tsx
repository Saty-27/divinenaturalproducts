...
export default function BrandSettings() {
  ...
  useEffect(() => {
    if (settings) {
      setFormData({
        brandName: settings.brandName || "Divine Naturals",
            ...
            <CardContent className="p-6 space-y-4">
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  placeholder="e.g., Divine Naturals"
                  className="rounded-xl border-gray-200 focus:border-green-500 focus:ring-green-500"
                />
                <p className="text-xs text-gray-400 italic">This will replace "Divine Naturals" everywhere on the site.</p>
              </div>
            </CardContent>
          </Card>
