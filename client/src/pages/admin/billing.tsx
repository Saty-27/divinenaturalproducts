...
export default function AdminBillingPage() {
  ...
  const tabStyle = (t: string) => ({
    ...
    background: activeTab === t ? "#16a34a" : "white", color: activeTab === t ? "white" : "#6b7280",
                      ...
                      {(bills as Bill[]).map((bill, index) => (
                        <tr key={bill.id} style={{ borderBottom: "1px solid #f3f4f6" }}>
                          ...
                          <td style={{ padding: "12px 16px", display: "flex", gap: "6px", alignItems: "center", flexWrap: "nowrap" }}>
                            ...
                            <a href={`/api/bills/${bill.id}/pdf`} download style={{ ...S.btn("#16a34a"), textDecoration: "none" }}>PDF</a>
                          </td>
                        </tr>
                      ))}
                    </tbody>
              ...
              <div style={{ display: "grid", gap: "1.25rem" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "1rem", background: "#f0fdf4", borderRadius: "8px", border: "1px solid #bbf7d0" }}>
                  ...
                  <label style={{ position: "relative", display: "inline-block", width: "52px", height: "28px", cursor: "pointer" }}>
                    ...
                    <span style={{ position: "absolute", inset: 0, borderRadius: "28px", background: settingsForm.isOnlinePaymentEnabled ? "#16a34a" : "#d1d5db", transition: "0.3s" }}>
                ...
                <div>
                  ...
                  <input value={settingsForm.upiId} onChange={(e) => setSettingsForm((f) => ({ ...f, upiId: e.target.value }))}
                    placeholder="e.g. divinenatural@upi"
                ...
                <button
                  ...
                  style={{ ...S.btn("#16a34a"), justifyContent: "center", padding: "12px 24px", fontSize: "15px", opacity: savingSettings ? 0.6 : 1 }}
                >
          ...
          <div style={{ background: "white", borderRadius: "16px", padding: "2rem", width: "440px", maxWidth: "90vw" }}>
            ...
            <div style={{ display: "flex", gap: "8px" }}>
              <button
                ...
                style={{ ...S.btn("#16a34a"), flex: 1, justifyContent: "center", padding: "10px", opacity: !uploadingFile || isUploading ? 0.5 : 1 }}
              >
